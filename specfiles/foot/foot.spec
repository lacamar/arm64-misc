 ...
 * Sixel image support
 * Session save/restore in server mode (downstream patch)
...
* Fri May 15 2026 Lachlan Marie <lchlnm@pm.me> - 1.27.0-1
 - Update to 1.27.0

* Mon Mar 23 2026 Lachlan Marie <lchlnm@pm.me> - 1.26.1-1
 - Update to 1.26.1
